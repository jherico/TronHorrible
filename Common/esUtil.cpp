...
EGLBoolean WinCreate(ESContext *esContext, const char *title)
{
    ...
    win = XCreateWindow(
               x_display, root,
               esContext->x, esContext->y, esContext->width, esContext->height, 0,
...
//
GLboolean ESUTIL_API esCreateWindow ( ESContext *esContext, const char* title, GLint width, GLint height, GLuint flags, GLint x, GLint y)
{
   EGLint attribList[] =
   {
       EGL_RED_SIZE,       5,
